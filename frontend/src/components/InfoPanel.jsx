export default function InfoPanel() {
  return (
    <div style={{ maxWidth: 820 }}>
      <h3 style={{ margin: "0 0 10px 0", fontSize: 17, fontWeight: 700 }}>HOW TO READ THE OUTPUT</h3>
      ...
      <div style={{ fontSize: 18, fontWeight: 800, letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 6 }}>
        DATA OVERVIEW
      </div>
      <div style={{ height: 1, background: "var(--border)", margin: "0 0 10px 0" }} />
      <p style={{ fontSize: 14, lineHeight: 1.6, margin: "0 0 10px 0" }}>
      ...
      <div style={{ height: 1, background: "var(--border)", margin: "0 0 10px 0" }} />
      <p style={{ fontSize: 14, lineHeight: 1.6, margin: "0 0 8px 0" }}>
      ...
      <p style={{ fontSize: 14, lineHeight: 1.6, margin: "0 0 8px 0" }}>
        <strong>Logistic regression</strong> is used when the outcome is 0/1. It predicts the probability of the “1” outcome.
      </p>
      <p style={{ fontSize: 14, lineHeight: 1.6, margin: "0 0 8px 0" }}>
        <strong>Odds ratios</strong> show how a one‑unit increase in a predictor changes the odds of the outcome. Values above 1
        increase odds; below 1 decrease odds.
      </p>
      <p style={{ fontSize: 14, lineHeight: 1.6, margin: "0 0 8px 0" }}>
        <strong>ROC curve + AUC</strong> summarize classification quality. AUC closer to 1 is better; 0.5 is no better than
        guessing.
      </p>
      <p style={{ fontSize: 14, lineHeight: 1.6, margin: "0 0 8px 0" }}>
        <strong>Confusion matrix</strong> breaks predictions into correct/incorrect counts to understand error types.
      </p>
      ...
      <div style={{ fontSize: 18, fontWeight: 800, letterSpacing: 1.2, textTransform: "uppercase", margin: "16px 0 6px 0" }}>
        MODEL COMPARISON
      </div>
      <div style={{ height: 1, background: "var(--border)", margin: "0 0 10px 0" }} />
      <p style={{ fontSize: 14, lineHeight: 1.6, margin: "0 0 8px 0" }}>
        <strong>AIC/BIC</strong> compare model fit while penalizing complexity. Lower is better.
      </p>
      <p style={{ fontSize: 14, lineHeight: 1.6, margin: "0 0 8px 0" }}>
        <strong>Nested F‑tests</strong> tell whether a larger model improves fit over a smaller one.
      </p>
      <p style={{ fontSize: 14, lineHeight: 1.6, margin: 0 }}>
        <strong>Cross‑validation MSE</strong> estimates out‑of‑sample error. Lower is better.
      </p>
    </div>
  );
}
