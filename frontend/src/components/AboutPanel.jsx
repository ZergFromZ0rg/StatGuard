export default function AboutPanel({ showInstructions = true }) {
  return (
    <div style={{ maxWidth: 820 }}>
      <h3 style={{ margin: "0 0 10px 0", fontSize: 17, fontWeight: 700 }}>ABOUT CSV MATRIX</h3>
      ...
      {showInstructions && (
        <>
          ...
          <ol style={{ margin: "0 0 12px 0", paddingLeft: 0, listStylePosition: "inside", lineHeight: 1.7, fontSize: 14 }}>
      ...
      <div style={{ height: 1, background: "var(--border)", margin: "0 0 10px 0" }} />
      <ul style={{ margin: "0 0 12px 0", paddingLeft: 0, listStylePosition: "inside", lineHeight: 1.7, fontSize: 14 }}>
